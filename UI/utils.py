...
def reverse_process_prompts(
    ...
    for box_points, box_labels, box in zip(
        points_by_box[0], labels_by_box[0], boxes[0]
    ):
...
def generate_footer(metadata):
    ...
    logo = f"""
        <a href="{homepages[namespace]}">
          <div align="center">
            <img src="https://raw.githubusercontent.com/ai4os/deepaas_ui/refs/heads/master/_static/images/favicon.ico" width="100" />
          </div>
        </a>
    """
