...
```bash
$ python -m ai4life.make_dataset {your_arguments}
$ python -m ai4life.make_model {your_arguments}
$ python -m ai4life.compare_models {your_arguments}
```
...
```bash
$ python -m ai4life.dataset.make_dataset {your_arguments}
$ python -m ai4life.models.make_model {your_arguments}
$ python -m ai4life.visualization.compare_models {your_arguments}
```
